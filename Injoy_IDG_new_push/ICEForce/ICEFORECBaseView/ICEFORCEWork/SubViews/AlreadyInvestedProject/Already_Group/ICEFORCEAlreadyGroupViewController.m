//
//  ICEFORCEAlreadyGroupViewController.m
//  InjoyIDG
//
...
@interface ICEFORCEAlreadyGroupViewController ()<UITableViewDelegate,UITableViewDataSource,ICEFORCEAlreadyRootDelegate>{
    float total;
    float pageCount;
}
...
@implementation ICEFORCEAlreadyGroupViewController
