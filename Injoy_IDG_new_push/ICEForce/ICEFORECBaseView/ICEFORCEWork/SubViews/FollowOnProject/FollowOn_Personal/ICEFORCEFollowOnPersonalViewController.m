//
//  ICEFORCEFollowOnPersonalViewController.m
//  InjoyIDG
//
...
@interface ICEFORCEFollowOnPersonalViewController ()<UITableViewDelegate,UITableViewDataSource,ICEFORCEFollowOnDelegate>{
    float total;
    float pageCount;
}
...
@implementation ICEFORCEFollowOnPersonalViewController
