//
//  ICEFORCEFollowOnViewController.m
//  InjoyIDG
//
...
#import "ICEFORCEFollowOnPersonalViewController.h"


@interface ICEFORCEFollowOnViewController ()<WMSegmentDelegate>

@end

@implementation ICEFORCEFollowOnViewController
...
-(void)loadSubView{
    ...
    ICEFORCEFollowOnPersonalViewController *personal = [[ICEFORCEFollowOnPersonalViewController alloc]init];
    ICEFORCEFollowOnGroupViewController *group = [[ICEFORCEFollowOnGroupViewController alloc]init];
