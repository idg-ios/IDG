//
//  CXIDGResearchReportListTableViewCell.m
//  InjoyIDG
//
...
@interface CXIDGResearchReportListTableViewCell()

@property (nonatomic, strong) CXIDGResearchReportListModel * model;
...
@implementation CXIDGResearchReportListTableViewCell
...
- (void)setCXIDGResearchReportListModel:(CXIDGResearchReportListModel *)model
{
    _model = model;
    [self layoutUI];
}
...
- (void)layoutUI
{
    ...
    _projManagerNameLabel.text = _model.authorName;
    ...
    _projNameLabel.text = _model.docName;
    ...
    _businessLabel.text = _model.summary;
