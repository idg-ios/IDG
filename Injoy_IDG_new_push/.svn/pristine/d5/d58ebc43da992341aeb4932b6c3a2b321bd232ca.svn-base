...
//    CGSize nameLabelSize = [self sizeWithString:[NSString stringWithFormat:@"%@的出差",dataModel.apply] font:kFontSizeForDetail maxSize:CGSizeMake(namLabelWidth, MAXFLOAT)];
    ...
    [titleLabel sizeToFit];
    testLabel.attributedText = [self setString:[NSString stringWithFormat:@"%@", dataModel.remark] andFont:kFontTimeSizeForForm];
    ...
    self.reasonLabelF = CGRectMake(margin+titleLabel.frame.size.width, CGRectGetMaxY(self.cityLabelF), cellWidth, reasonSize.height);
