//
//  SDInvitePictureViewController.m
//  InjoyIM_YJ
//
//  Created by wtz on 2017/8/3.
...
@interface SDInvitePictureViewController ()<SDMenuViewDelegate,UIGestureRecognizerDelegate>
...
@implementation SDInvitePictureViewController
