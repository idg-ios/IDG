//
//  CXPromotionActivitieViewController.m
//  InjoyERP
//
...
@interface CXPromotionActivitieViewController ()<UITableViewDelegate, UITableViewDataSource,CXWorkCreateDetailViewReloadHeightDelegate>
...
@implementation CXPromotionActivitieViewController
...
- (void)setupView
{
    ...
    [self.rootTopView setNavTitle:LocalString(@"活动推广")];
    ...
    if (_sendAnnexDataArray.count) {
        ...
        [HttpTool multipartPostFileDataWithPath:[NSString stringWithFormat:@"%@/annex/fileUpload",urlPrefix] params:params dataAry:self.sendAnnexDataArray success:^(id JSON){
            if ([JSON[@"status"] integerValue] == 200) {
                ...
                [params setValue:@(43) forKey:@"type"];
