...
@interface CXZJYXLGSListTableViewCell()

@property (nonatomic, strong) CXZJYXLGSListModel * model;
...
@implementation CXZJYXLGSListTableViewCell
...
- (void)layoutUI
{
    ...
    _induNameLabel.text = _model.indusType;
    ...
    _businessLabel.text = _model.createDate;
