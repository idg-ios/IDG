 ...
 *  弹出菜单
 */
typedef NS_ENUM(NSInteger,SDChattingCellMenuItem) {
    /**
     *  复制
     */
    SDChattingCellMenuItemCopy,
    /**
     *  删除
     */
    SDChattingCellMenuItemDelete,
    /**
     *  转发
     */
    SDChattingCellMenuItemForward
};

@class SDChattingCell;
@protocol SDChattingCellDelegate <NSObject>
...
@interface SDChattingCell : UITableViewCell
#pragma mark - 外部方法
...
@property (nonatomic,weak) id<SDChattingCellDelegate> delegate;
// 传出参数
