//
//  CXResearchReportListSearchView.m
//  InjoyIDG
//
...
@interface CXResearchReportListSearchView()<UISearchBarDelegate>
...
@implementation CXResearchReportListSearchView{
    /** 遮罩层 */
...
- (void)searchBarTextDidEndEditing:(UISearchBar *)searchBar{
    if(self.onSearchBarEndCallBack){
        self.onSearchBarEndCallBack(searchBar.text);
    }
}
#pragma mark - Event
...
- (void)onSearchButtonTap {
    if (self.onSearchCallback) {
        ...
        self.onSearchCallback(bgmc, zy, keyword);
    }
    [self hide];
}
