...
- (instancetype)initWithFrame:(CGRect)frame andImage:(UIImage *)image andHignIcon:(NSString *)hignIcon
{
    ...
    if (self) {
        ...
        [imageView sd_setImageWithURL:[NSURL URLWithString:(hignIcon && ![hignIcon isKindOfClass:[NSNull class]])?hignIcon:@""] placeholderImage:image options:EMSDWebImageRetryFailed];
