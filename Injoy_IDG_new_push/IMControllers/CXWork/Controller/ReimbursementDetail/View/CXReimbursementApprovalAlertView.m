//
//  CXReimbursementApprovalAlertView.m
//  InjoyIDG
//
...
@interface CXReimbursementApprovalAlertView()<UITextViewDelegate,UIGestureRecognizerDelegate>
...
/// _subObjId
@property(strong, nonatomic) NSNumber *subObjId;
/// _affairId
@property(strong, nonatomic) NSNumber * affairId;
@property(strong, nonatomic) DLRadioButton *radioButton_1;
@property(strong, nonatomic) DLRadioButton *radioButton_2;

@end

@implementation CXReimbursementApprovalAlertView{
...
- (void)show {
    ...
    [self mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(approval_height * 5);
...
- (void)setUpCenterView:(UIView *)centerView {
    ...
    [self.radioButton_2 setTitle:@"退回" forState:UIControlStateNormal];
...
- (void)btnEvent:(UIButton *)sender {
    ...
    if ([@"提交" isEqualToString:title]) {
        ...
        param[@"subObjId"] = _subObjId;
        param[@"affairId"] = _affairId;
        param[@"kind"] = [self.suggestion isEqualToString:@"同意"] ? @(1) : @(2);
...
- (void)setUpUI {
    ...
    [titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.height.mas_equalTo(approval_height);
    ...
    [centerView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(approval_height * 3);
    }];
...
- (instancetype)initWithSubObjId:(NSNumber *)subObjId affairId:(NSNumber *)affairId {
    if (self = [super initWithFrame:(CGRect) {0.f, 0.f, Screen_Width, approval_height * 5}]) {
