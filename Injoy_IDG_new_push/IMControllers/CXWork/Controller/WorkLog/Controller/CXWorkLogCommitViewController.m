//
//  CXWorkLogViewController.m
//  InjoyIM_YJ
//
//  Created by wtz on 2017/8/1.
...
@interface CXWorkLogCommitViewController ()<UITableViewDelegate, UITableViewDataSource,CXWorkCreateDetailViewReloadHeightDelegate>
...
@implementation CXWorkLogCommitViewController
...
- (void)setupView
{
    ...
    [self.rootTopView setNavTitle:LocalString(@"工作日志")];
    ...
    if (_sendAnnexDataArray.count) {
        ...
        [HttpTool multipartPostFileDataWithPath:[NSString stringWithFormat:@"%@/annex/fileUpload",urlPrefix] params:params dataAry:self.sendAnnexDataArray success:^(id JSON){
            if ([JSON[@"status"] integerValue] == 200) {
                ...
                selectContactViewController.type = CXWorkLogType;
