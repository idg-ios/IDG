//
//  CXGoodsPromotionViewController.m
//  InjoyERP
//
...
@interface CXGoodsPromotionViewController ()<UITableViewDelegate, UITableViewDataSource,CXWorkCreateDetailViewReloadHeightDelegate>
...
@implementation CXGoodsPromotionViewController
...
- (void)setupView
{
    ...
    [self.rootTopView setNavTitle:LocalString(@"商品推广")];
    ...
    if (_sendAnnexDataArray.count) {
        ...
        [HttpTool multipartPostFileDataWithPath:[NSString stringWithFormat:@"%@/annex/fileUpload",urlPrefix] params:params dataAry:self.sendAnnexDataArray success:^(id JSON){
            if ([JSON[@"status"] integerValue] == 200) {
                ...
                [params setValue:@(42) forKey:@"type"];
