//
//  CXYunJingWorkCircleMyselfViewController.m
//  InjoyYJ1
//
...
@interface CXYunJingWorkCircleMyselfViewController ()<UITableViewDataSource, UITableViewDelegate,IBActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate,ALiImageReshapeDelegate>
...
@implementation CXYunJingWorkCircleMyselfViewController
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    CXYunJingWorkCircleMyselfCell * cell = [tableView dequeueReusableCellWithIdentifier:cellName];
    if(!cell){
        cell = [[CXYunJingWorkCircleMyselfCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
...
{
    return [CXYunJingWorkCircleMyselfCell getCXMyselfWorkTableViewCellHeightWithCXAllPeoplleWorkCircleModel:self.dataSource[indexPath.row]];
}
