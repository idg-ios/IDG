//
//  CXWorkCircleDetailRecordCell.m
//  InjoyERP
//
...
@interface CXWorkCircleDetailRecordCell()
...
@implementation CXWorkCircleDetailRecordCell
...
- (void)layoutUI
{
    _grayBackGroundView.frame = CGRectMake(kWorkCircleDetailCommentHeadLeftSpace, 0, Screen_Width - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadLeftSpace, [CXWorkCircleDetailRecordCell getCellHeightWithCXWorkCircleDetailRecordModel:self.model] - 0.5);
    ...
    CGSize commentLabelSize = [_commentLabel sizeThatFits:CGSizeMake(Screen_Width - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadWidth - kNameLeftSpace - kWorkCircleDetailCommentHeadLeftSpace, LONG_MAX)];
    ...
    _bottomLineView.frame = CGRectMake(0, [CXWorkCircleDetailRecordCell getCellHeightWithCXWorkCircleDetailRecordModel:self.model] - 0.5, Screen_Width - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadLeftSpace, 0.5);
...
+ (CGFloat)getCellHeightWithCXWorkCircleDetailRecordModel:(CXWorkCircleDetailRecordModel *)model
{
    ...
    CGSize commentLabelSize = [commentLabel sizeThatFits:CGSizeMake(Screen_Width - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadLeftSpace - kWorkCircleDetailCommentHeadWidth - kNameLeftSpace - kWorkCircleDetailCommentHeadLeftSpace, LONG_MAX)];
