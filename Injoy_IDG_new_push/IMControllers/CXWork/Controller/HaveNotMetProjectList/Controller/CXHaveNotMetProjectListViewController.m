//
//  CXHaveNotMetProjectListViewController.m
//  InjoyIDG
//
...
@interface CXHaveNotMetProjectListViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation CXHaveNotMetProjectListViewController
...
- (void)getListWithPage:(NSInteger)page {
    NSString *url = [NSString stringWithFormat:@"%@project/potential/list/unDate/%ld", urlPrefix, (long) page];
