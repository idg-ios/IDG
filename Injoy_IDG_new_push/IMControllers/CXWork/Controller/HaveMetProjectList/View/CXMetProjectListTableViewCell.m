//
//  CXMetProjectListTableViewCell.m
//  InjoyIDG
//
...
@interface CXMetProjectListTableViewCell()

@property (nonatomic, strong) CXMetProjectListModel * model;
...
@implementation CXMetProjectListTableViewCell
...
- (void)setCXMetProjectListModel:(CXMetProjectListModel *)model
{
    _model = model;
    [self layoutUI];
}
...
- (void)layoutUI
{
    ...
    _projManagerNameLabel.text = _model.userName;
    ...
    _induNameLabel.text = _model.comIndus;
    ...
    _businessLabel.text = _model.bizDesc;
