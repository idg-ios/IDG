//
//  CXIDGConferenceInformationListViewController.m
//  InjoyIDG
//
...
@interface CXIDGConferenceInformationListViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation CXIDGConferenceInformationListViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CXIDGConferenceInformationDetailViewController *vc = [[CXIDGConferenceInformationDetailViewController alloc] init];
...
- (void)getListWithPage:(NSInteger)page {
    NSString *url = [NSString stringWithFormat:@"%@project/opinion/list/%zd", urlPrefix, [self.model.projId integerValue]];
