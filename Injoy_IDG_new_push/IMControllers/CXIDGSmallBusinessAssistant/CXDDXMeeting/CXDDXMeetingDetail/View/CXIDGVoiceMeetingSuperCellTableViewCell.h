//
//  CXIDGVoiceMeetingSuperCellTableViewCell.h
//  InjoyIDG
//
//  Created by wtz on 2017/11/23.
 ...
 *  弹出菜单
 */
typedef NS_ENUM(NSInteger,CXIDGVoiceMeetingSuperCellTableViewCellMenuItem) {
    /**
     *  复制
     */
    CXIDGVoiceMeetingSuperCellTableViewCellMenuItemCopy,
    /**
     *  删除
     */
    CXIDGVoiceMeetingSuperCellTableViewCellMenuItemDelete,
    /**
     *  转发
     */
    CXIDGVoiceMeetingSuperCellTableViewCellMenuItemForward
};

@class CXIDGVoiceMeetingSuperCellTableViewCell;
@protocol CXIDGVoiceMeetingSuperCellTableViewCellDelegate <NSObject>
 ...
 *  @param message 消息对象
 */
-(void)chattingCell:(CXIDGVoiceMeetingSuperCellTableViewCell *)cell didTapMenuItem:(CXIDGVoiceMeetingSuperCellTableViewCellMenuItem)item message:(CXIMMessage *)message;
 ...
 *  @param null 空对象
 */
- (void)chattingCell:(CXIDGVoiceMeetingSuperCellTableViewCell *)cell didTapSendFailedBtn:(void *)null;
 ...
 *  @param null 空对象
 */
- (void)chattingCell:(CXIDGVoiceMeetingSuperCellTableViewCell *)cell didTapAvatar:(void *)null;
 ...
 *  @param null 空对象
 */
- (void)chattingCell:(CXIDGVoiceMeetingSuperCellTableViewCell *)cell didStartBurnMessagesAfterReadTimer:(void *)null;

@end

@interface CXIDGVoiceMeetingSuperCellTableViewCell : UITableViewCell

#pragma mark - 外部方法
+(NSString *)identifierForContentType:(CXIMMessageContentType)type;
+(CXIDGVoiceMeetingSuperCellTableViewCell *)createCellForIdentifier:(NSString *)identifier;

#pragma mark - 外部属性
// 传入参数
@property (nonatomic,strong) CXIMMessage *message;
@property (nonatomic,strong) CXDDXVoiceModel *model;
@property (nonatomic,assign) NSInteger compareTime;
@property (nonatomic,strong) NSIndexPath *indexPath;
@property (nonatomic,weak) UITableView *tableView;
@property (nonatomic,weak) id<CXIDGVoiceMeetingSuperCellTableViewCellDelegate> delegate;
// 传出参数
...
/** 上级或者平级能看对方位置 */
@property (nonatomic, assign) BOOL canSeeLocation;
#pragma mark - 子类控件
/**
 *  时间label
 */
 ...
 *  @return 是否启用
 */
- (BOOL)menuItemEnabled:(CXIDGVoiceMeetingSuperCellTableViewCellMenuItem)item;
